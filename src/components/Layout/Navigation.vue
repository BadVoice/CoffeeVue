<template>
          ...
          <div class="flex  w-full content-around items-center justify-around md:justify-end gap-10">
            ...
            >Sign in</RouterLink>
              ...
              <div class=" flex  items-center"
                v-if="closeSearch"
             >
                <input type="" name="" class=" py-1 rounded-md border-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-[#2d7e65] focus:border-[#2d7e65] focus:z-10 sm:text-sm ">
                <a @click="closeSearch != closeSearch"
                href="#" class="cursor-pointer px-1  hover:text-gray-500"
                >
                  <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <!-- Cart -->
              <div class=" flow-root">
                <a ref="#"  class="group -m-2 flex items-center p-2 cursor-pointer hover:text-gray-500"
  ...
  <div class="sm:hidden  flex-col" id="mobile-menu"
      v-show="burgerActive">
    <div 
    ref="burgerRef"
